...
# At Third We Will Use Logistic Regression

from sklearn.linear_model import LogisticRegression
lr = LogisticRegression()
lr.fit(X_train,y_train)
y_pred_lr = lr.predict(X_valid)
print('Logistic Regression Accuracy Score : ', accuracy_score(y_valid,y_pred_lr))
cm_rfc=my_confusion_matrix(y_valid, y_pred_lr, 'Logistic Regression Confusion Matrix')
